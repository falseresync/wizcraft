...
public class CrucibleEmiRecipe implements EmiRecipe {
    ...
    protected final RecipeEntry<CrucibleRecipe> backingRecipe;
    protected final Identifier id;
    protected final EmiStack result;
    protected final List<EmiIngredient> inputs;

    public CrucibleEmiRecipe(RecipeEntry<CrucibleRecipe> recipeEntry) {
    ...
    @Nullable
    @Override
    public RecipeEntry<CrucibleRecipe> getBackingRecipe() {
