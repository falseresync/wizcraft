...
import ru.falseresync.wizcraft.client.util.Color;

public class MagicCauldronBlockEntityRenderer implements BlockEntityRenderer<MagicCauldronBlockEntity> {
    public MagicCauldronBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    }
